...
<div class="m_left">
    ...
    <div class="left_m">
        ...
        <div class="m_right">
            <p></p><div class="mem_tit">我的订单</div>
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
                <?php foreach($data as $k=>$v): ?>
                <tr>
                    <td><font color="#ff4e00"><?php echo $v->time; ?></font></td>
                    <td><font color="#ff4e00"><?php echo $v->context; ?></font></td>
                </tr>
                <?php endforeach; ?>
            </table>
        </div>
