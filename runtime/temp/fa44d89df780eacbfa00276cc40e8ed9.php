...
<div class="i_bg">  
    ...
    <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right">
            商品总价: <font color="#ff4e00" id="total">￥0</font>  + 积分: <font color="#ff4e00" id="score">15R</font>
        </td>
      </tr>
      <tr height="70">
        <td align="right">
