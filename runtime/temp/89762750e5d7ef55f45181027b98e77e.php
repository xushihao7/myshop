...
<div class="i_bg">
	<div class="postion">
        <span class="fl">全部商品 ><a href="<?php echo url('Product/productList'); ?>?cate_id=<?php echo $cInfo['cate_id']; ?>"><?php echo $cInfo['cate_name']; ?></a></span>
    ...
    <div class="content mar_20">
    	<div class="l_history">
        	...
        	<ul>
            <?php if($historyInfo != ''): foreach($historyInfo as $k=>$v): ?>
            	<li>
                    <div class="img"><a href="<?php echo url('Product/detail'); ?>?goods_id=<?php echo $v['goods_id']; ?>"><img src="__ROOT__/goods_img/<?php echo $v['goods_img']; ?>" width="185" height="162" /></a></div>
                	<div class="name"><a href="#"><?php echo $v['goods_name']; ?></a></div>
                    <div class="price">
