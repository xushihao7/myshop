...
<div class="i_bg">
    <div class="content mar_20">
        <table  border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
            ...
            <tr >
                <input type="hidden" class="order_number" order_number="<?php echo $order_number; ?>">
                <td >
                ...
                <td align="center" >
                    <?php echo $v['buy_number']; ?>
                </td>
                <td align="center"><?php echo $v['buy_number'] * $v['self_price']; ?></td>
                <td align="center">
                    <a href="javascript:;" self_price="<?php echo $v['self_price']; ?>" class="refund" order_id="<?php echo $v['order_id']; ?>" goods_id="<?php echo $v['goods_id']; ?>" buy_number="<?php echo $v['buy_number']; ?>" >
                        退款
                    </a>&nbsp; &nbsp;
                </td>
            </tr>
