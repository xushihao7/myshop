    ...
    <div class="left_m">
		...
		<div class="m_right">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>  <a href="<?php echo url('Member_order/orderDetail'); ?>?order_number=<?php echo $v['order_number']; ?>">
                    <font color="#ff4e00">
                    <?php echo $v['order_number']; ?></font>
                </a>
                </td>
                ...
                <td>已付款，已确认，已发货</td>
                <?php endif; if($v['order_status'] == 1): ?>
                <td><a href="javascript:;" class="cancel" order_number="<?php echo $v['order_number']; ?>">取消订单</a>
                    <a href="<?php echo url('order/alipay'); ?>?order_number=<?php echo $v['order_number']; ?>">去付款</a>
                </td>
                  <?php elseif($v['order_status'] == 3): ?>
                  <td> <a href="<?php echo url('order/refund'); ?>?order_id=<?php echo $v['order_id']; ?>&&order_number=<?php echo $v['order_number']; ?>">退款</a></td>
                  <?php elseif($v['order_status'] == 2): ?>
                  <td></td>
                  <?php elseif($v['order_status'] == 4): ?>
                  <td> 等待发货</td>
        ...
        $(function(){
            layui.use(['layer'],function(){
                $(".cancel").click(function(){
                    ...
                    $.post(
                        "<?php echo url('Order/orderCancel'); ?>",
                        {order_number:order_number},
                        function(result){
                            layer.msg(result.font,{icon:result.code})
                            if(result.code==1){
                                location.href="<?php echo url('member_order/orderList'); ?>"
                            }
                        }
                        ,'json'
                    )
