...
<div class="i_bg bg_color">
                        ...
                        <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
                            ...
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="<?php echo url('Product/detail'); ?>?goods_id=<?php echo $v['goods_id']; ?>"><img width="160" height="136" src="__ROOT__/goods_img/<?php echo $v['goods_img']; ?>"></a>
                                    </div>                                        
                                    <div class="name">
    ...
    <div style="text-align: center"><a href="javascript:;" id="more" ><font color='red' size='3px' >加载更多</font></a></div>
           ...
           $.post(
               ...
               function(result){
                   if(result!==""){
                       ...
                       _this.parent().hide();
                       _this.parent().after("<div style='text-align:center '><a href='#'><font color='red' size='3px'>没有更多了,已经到底部了</font></a></div>")
                   }
